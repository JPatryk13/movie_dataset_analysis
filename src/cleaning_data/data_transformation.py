...
from cleaning import CleanMoviesMetadata, CleanCast
...
if __name__ == "__main__":
    ...
    #
    # people_before_concat = mdfcast.create_df(columns=['person_id', 'gender', 'name', 'profile_path'],
