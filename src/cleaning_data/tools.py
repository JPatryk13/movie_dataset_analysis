...
def make_junction_table(
    ...
    :param old_index_names: (optional) old index column names - by default both set to "index" (<left_df_index>,
    <right_df_index>)
    ...
    #  .
    #  verify that both column names exist in left/right_df (<left_df_index>, <right_df_index>)
